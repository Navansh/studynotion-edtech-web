...
//   } }
  ...
  const resultEnrolledStudents = await enrollStudents(courses, newId, res);

  console.log(
    "This is the result of enrolled students",
    resultEnrolledStudents
  );

  if (!resultEnrolledStudents) {
    return res.json({
      success: false,
      message: "Could not enroll the students",
    });
  } else {
    return res.json({
      success: true,
  ...
  //****Would have used this if we had Razorpay Credentials */
  ...
  //     });
  //   } catch (error) {
  //     console.log("This is the error faced", error);
  //     res
  //       .status(500)
  //       .json({
  //         success: false,
  //         message: "Could not initiate order in the Payments.js file.",
  //         error: error,
  //       });
  //   }
};
...
const enrollStudents = async (courses, userId, res) => {
  console.log("this hits the enroll students call");
