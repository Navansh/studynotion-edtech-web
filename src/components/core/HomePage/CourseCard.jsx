...
const CourseCard = ({heading, description,level, lessonNumber, currentCard, setCurrentCard}) => {
  return (
    <div className={`${currentCard === heading ? " bg-richblack-5 shadow-[12px_12px_0_0] shadow-yellow-50" : "bg-richblack-800 text-white" } flex flex-col gap-3 lg:w-[30%]`} onClick={setCurrentCard} >
