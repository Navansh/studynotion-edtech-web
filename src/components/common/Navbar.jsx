                ...
                <li key={index}>
                  {link.title === "Catalog" ? (
                    <div className=" relative flex items-center group">
                      ...
                      <div
                        className=" invisible absolute left-[5%] -translate-x-28 top-[40px] flex flex-col
                      ...
                      >
                        {sublinks && sublinks.length ? (
                          sublinks.map((sublink, index) => {
                            return (
                              <div
                                className=" hover:bg-richblack-100 z-10 p-3 rounded-lg"
                                key={index}
                              >
                        ...
                        <div className=" absolute left-[50%] z-[3] -top-1 h-6 w-6 rotate-45 rounded bg-richblack-5"></div>
                      </div>
                    </div>
                  ) : (
                    <Link to={link?.path}>
